import { PageWithChildren } from "@jitl/notion-api";
import { Title } from "../notion-cms";
export declare const getFrontmatter: (page: PageWithChildren) => {
    plain: {
        Name: string;
        Aliases: string;
    };
...
export declare const AuthorToNotion: (author: Author) => NotionAuthor;
export declare type NotionAuthor = {
    Name: Title;
};
export declare const prepareAuthorsForNotion: (author: string) => Author;
